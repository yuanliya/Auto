...
namespace NJUST.AUTO06.Modbus.IO
{
    public class TcpClientAdapter : IStreamResource
    {
		...
		{
			get { return tcpClient.ReadTimeout; }
			set { tcpClient.ReadTimeout = value; }
		}
		...
		{
            get { return tcpClient.WriteTimeout; }
            set { tcpClient.WriteTimeout = value; }
		}
